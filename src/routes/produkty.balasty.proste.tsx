...
export const Route = createFileRoute("/produkty/balasty/proste")({
  head: () => ({
    meta: [
      { title: "Balasty proste do ciągników — DMBK" },
      { name: "description", content: "Balasty proste DMBK — klasyczna geometria, wagi 300–1800 kg, lakier proszkowy, opcjonalne LED i personalizacja." },
      { property: "og:image", content: ballastImg },
    ],
  }),
  component: BalastyProste,
});

const gallery = [ballastImg, ballastImg, ballastImg, ballastImg];
const specs: [string, string][] = [
  ["Wagi", "300 – 1800 kg"],
  ["Geometria", "Prosta, frontowa"],
    ...
    <SiteLayout>
      <section className="border-b border-border">
        <div className="container-x py-6 text-xs uppercase tracking-widest text-muted-foreground">
          ...
          <ChevronRight size={12} className="inline mx-2" />
          <span className="text-foreground">Proste</span>
        </div>
      </section>
      ...
      <section className="container-x py-16 lg:py-20 grid lg:grid-cols-[1.2fr_1fr] gap-12 items-start">
        <div>
          <div className="relative">
            ...
            <img src={ballastImg} alt="Balast prosty DMBK" className="relative w-full object-cover border border-border" />
          </div>
        ...
        <div>
          <span className="text-xs uppercase tracking-[0.25em] text-primary">/ Wariant A</span>
          <h1 className="mt-3 font-display text-4xl lg:text-5xl uppercase leading-tight">
            Balasty proste
          </h1>
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Klasyczna, prosta geometria — maksymalna masa przy minimalnym wysięgu. Sprawdzona konstrukcja
            do codziennej pracy. Idealne tam, gdzie liczy się przyczepność i niezawodność.
          </p>
