...
export const Route = createFileRoute("/produkty/balasty")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Balasty do ciągników DMBK — wersje przednie i tylne, wagi 300–1800 kg, wersje proste i przeginane, opcja ze skrzynką." },
        ...
        <div className="container-x grid lg:grid-cols-2 gap-10 lg:gap-16 py-16 lg:py-24 items-center">
          <div>
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">
              Obciążniki poprawiające stabilność i przyczepność ciągnika. Dostępne w wersjach
              przednich i tylnych, w zakresie wag od 300 do 1800 kg. Warianty proste i przeginane,
              opcjonalnie ze skrzynką narzędziową.
            </p>
